<footer class="footer blog-footer">
        <div class="containe">
               <!--- <ul class="list-inline mb-3 h5">
                ...
                <p class="text-muted">Copyright © Yeolom All Rights Reserved.<br/> This website was derived from <a href="https://github.com/KhalidLam">@KhalidLam</a> Simple Php Blog on Github.</p>
