...
<style>
    .bg-div {
        background: linear-gradient(rgba(0, 0, 0, 0.5),
                ...
                /**pexels-marc-mueller <-- Main picture bg */
        /* Full height */
        height: 680px;
        ...
        <div class="jumbotron text-center p-0 mb-0">
            <div class="bg-div px-5 d-flex align-items-center">
                ...
                <div class="text-left w-50">
                    <h1 class="display-4 text-white">Welcome to Yeolom's Blog</h1>
                    <h2 class="display-5 text-white">Posts on Business, Software Engineering, Game development, and the likes avaliable for free.</h2>
